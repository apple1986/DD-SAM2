...
model_name = "dd_medsam2"
model_cfg = args.model_cfg
checkpoint = "/home/gxu/proj1/lesionSeg/utswtumor_track/MedSAM2_new/checkpoints_echocard/medsam2_ft/ft_img_adp_cnn_dw_di_v3_4_1e5_6adps_echocard/medsam2_best.pth"
...
for tv_type in tv_types:
    ...
    for data_four in testLoader:
        ...
        if curVid.shape[2] != 512:
            curVid = F.interpolate(curVid, size=(512, 512, curVid.shape[4]), mode='trilinear', align_corners=False)
            curGT = F.interpolate(curGT.float(), size=(512, 512, curVid.shape[4]), mode='nearest', align_corners=None)
