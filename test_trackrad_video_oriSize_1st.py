...
for NUM in range(0, 1):
    for tv_type in tv_types:
        save_eval_path = os.path.join(save_eval_path_root, "dataset_trackrad/tempeval_result_fix_1st_oneDir_"+tv_type)
        makedirs(save_eval_path, exist_ok=True)
        # # save segmentation results
        # pred_save_dir = os.path.join(save_eval_path_root, "dataset_trackrad/seg_result_fix_1st_twoDir_"+tv_type)
        ...
        testLoader = load_data(root_path, all_test_transform, batch_size=1, split=tv_type) # test, "all", brain_ctv
