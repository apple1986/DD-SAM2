...
parser.add_argument(
    "-pred_save_dir",
    type=str,
    default="/home/gxu/proj1/lesionSeg/utswtumor_track/MedSAM2_new/checkpoints_memo",
...
parser.add_argument(
    "-model_cfg",
    type=str,
    default="configs/sam2.1_hiera_t512_prune.yaml",
...
insert_pos = "memory_attention"
#############################
# initialized predictor
predictor = build_sam2_video_predictor_npz_apt(model_cfg, checkpoint, use_ft=use_ft, apt_flag="mem_noca", insert_pos=insert_pos) #
...
for tv_type in tv_types:
    ...
    # ## save format results
    # with open(os.path.join(save_seg_result_path, f"format_medsam2_prune_mean_dice_hd_nsd_asd0.txt"), "a") as f:
